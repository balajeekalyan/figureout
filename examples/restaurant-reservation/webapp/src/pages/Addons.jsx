...
const CATEGORY_ORDER = ["experience", "food", "drinks", "parking"];

export default function Addons() {
  const navigate = useNavigate();
  const { reservation, setAddons } = useCart();
  ...
  useEffect(() => {
    ...
    fetchAddons(reservation.restaurant_id)
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      const data = await askAddons(query, reservation?.restaurant_id);
